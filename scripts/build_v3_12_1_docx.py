"""Build V3.12.1 docx from markdown using zipfile + XML (python-docx unavailable).

Reuses the V3.11/V3.12 docx builder logic with V3.12.1 paths.
"""
import os
import re
import zipfile
...
MD_PATH = r"D:\ocn\paper_versions_ordered\V3_12_1_advisor_send_clean\CESE_OCN_V3_12_1_advisor_send_clean.md"
DOCX_PATH = r"D:\ocn\paper_versions_ordered\V3_12_1_advisor_send_clean\CESE_OCN_V3_12_1_advisor_send_clean.docx"
