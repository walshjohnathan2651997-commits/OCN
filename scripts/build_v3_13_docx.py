"""Build V3.13 docx from markdown using zipfile + XML (python-docx unavailable).

Reuses the V3.11/V3.12/V3.12.1 docx builder logic with V3.13 paths.
"""
import os
import re
import zipfile
...
MD_PATH = r"D:\ocn\paper_versions_ordered\V3_13_differentiated_against_rigourate_forcebench\CESE_OCN_V3_13_differentiated_against_rigourate_forcebench.md"
DOCX_PATH = r"D:\ocn\paper_versions_ordered\V3_13_differentiated_against_rigourate_forcebench\CESE_OCN_V3_13_differentiated_against_rigourate_forcebench.docx"
